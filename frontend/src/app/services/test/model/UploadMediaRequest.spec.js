...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.UploadMediaRequest();
  });
  ...
  describe('UploadMediaRequest', function() {
    it('should create an instance of UploadMediaRequest', function() {
      ...
      //var instance = new OpenApiDefinition.UploadMediaRequest();
      //expect(instance).to.be.a(OpenApiDefinition.UploadMediaRequest);
    });
