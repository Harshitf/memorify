...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.MessageResponse();
  });
  ...
  describe('MessageResponse', function() {
    it('should create an instance of MessageResponse', function() {
      ...
      //var instance = new OpenApiDefinition.MessageResponse();
      //expect(instance).to.be.a(OpenApiDefinition.MessageResponse);
    });
    ...
    it('should have the property messageState (base name: "messageState")', function() {
      // uncomment below and update the code to test the property messageState
      //var instance = new OpenApiDefinition.MessageResponse();
      //expect(instance).to.be();
    });
